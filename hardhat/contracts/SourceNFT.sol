...
contract SourceNFT {
    ...
    constructor(address destMinterAddress) {
        ...
        // from Base Sepolia
        address routerAddressBase = 0xD3b06cEbF099CE7DA4AcCf578aaebFDBd6e88a93;
        router = IRouterClient(routerAddressBase);
        linkToken = LinkTokenInterface(0xE4aB69C077896252FAFBD49EFD26B5D171A32410);
        linkToken.approve(routerAddressBase, type(uint256).max);
